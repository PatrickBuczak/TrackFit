...
@Component({
  selector: 'app-friends-list-admin',
  templateUrl: './friends-list-admin.component.html',
  styleUrls: ['./friends-list-admin.component.scss'],
  imports: [
    FormsModule,
    NgForOf,
...
export class FriendsListAdminComponent implements OnInit {
